...
const toCamelDeal = (d) => d && ({ id: d.id, ownerId: d.owner_id, company: d.company, contact: d.contact, value: Number(d.value), stage: d.stage, closeDate: d.close_date || "", notes: d.notes, lostReason: d.lost_reason || "", nextActionDate: d.next_action_date || "", stageChangedAt: d.stage_changed_at || "", apptCredited: d.appt_credited, createdAt: d.created_at, taggedRepId: d.tagged_rep_id || "", companyId: d.company_id || "" });
...
const fromCamelDeal = (d) => ({ ...(d.id ? { id: d.id } : {}), owner_id: d.ownerId, company: d.company, contact: d.contact, value: d.value, stage: d.stage, close_date: d.closeDate || null, notes: d.notes, lost_reason: d.lostReason || null, next_action_date: d.nextActionDate || null, ...(d.stageChangedAt !== undefined ? { stage_changed_at: d.stageChangedAt || null } : {}), appt_credited: d.apptCredited ?? false, tagged_rep_id: d.taggedRepId || null, company_id: d.companyId || null });
