...
const fromCamelDeal = (d) => ({ ...(d.id ? { id: d.id } : {}), owner_id: d.ownerId, company: d.company, contact: d.contact, contact_email: d.contactEmail || null, value: d.value, stage: d.stage, close_date: d.closeDate || null, notes: d.notes, lost_reason: d.lostReason || null, next_action_date: d.nextActionDate || null, ...(d.apptAt !== undefined ? { appt_at: d.apptAt || null } : {}), ...(d.stageChangedAt !== undefined ? { stage_changed_at: d.stageChangedAt || null } : {}), appt_credited: d.apptCredited ?? false, tagged_rep_id: d.taggedRepId || null, company_id: d.companyId || null });
